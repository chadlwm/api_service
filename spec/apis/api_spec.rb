  ...
  describe MagicT::API do
    describe "GET /v1/info" do
      it "returns data info from database" do
        ...
        JSON.parse(last_response.body).should == {'result' => 'success', 'result-code' => 200, 'message' => 'when you see this mesage, that means the server is running in test and serving for you, thans for using MagicT.'}
      end
    end
